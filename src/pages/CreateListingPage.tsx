...
export default function CreateListingPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8">$10 flat fee • Live for 60 days • Reaches thousands of Alaska buyers</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" value={title} onChange={e => setTitle(e.target.value)} required
              placeholder="e.g., 2020 Toyota Tacoma TRD Off-Road"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            ...
            <input type="text" value={year} onChange={e => setYear(e.target.value)} placeholder="2020"
          ...
          <div>
            ...
            <input type="text" value={model} onChange={e => setModel(e.target.value)} placeholder="Tacoma"
              className="w-full border border-gray-300 rounded-lg px-4 py-2" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Mileage</label>
            <input type="text" value={mileage} onChange={e => setMileage(e.target.value)} placeholder="45000"
              className="w-full border border-gray-300 rounded-lg px-4 py-2" />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea value={description} onChange={e => setDescription(e.target.value)} required rows={5}
            placeholder="Describe your vehicle — features, history, reason for selling..."
            className="w-full border border-gray-300 rounded-lg px-4 py-2" />
        </div>
