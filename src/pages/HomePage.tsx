    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Find Your Next Vehicle in Alaska
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100">
            Buy and sell cars, trucks, and more on the Kenai Peninsula. Simple 0 flat fee, trusted platform.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center text-gray-600">
          <p>Browse all listings to see available vehicles</p>
          <Link to="/browse" className="text-blue-600 hover:underline">View all vehicles →</Link>
        </div>
      </div>
